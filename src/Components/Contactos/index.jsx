            ...
            <footer id="contactos">
                  <article className="flex flex-col justify-center items-center max-w-[1200px] font-Montserrat p-8">
                        <div className="flex flex-col justify-center items-center">
                              ...
                              <p className="font-semibold gap-3 mt-10 text-center text-xl">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veniam, exercitationem nobis iste nostrum dolor deleniti quis commodi! Non est nesciunt iste dignissimos porro quisquam accusamus. Maxime consectetur esse tempore. Neque?</p>
                        </div>
                        <div className="lg:grid lg:grid-cols-2 gap-5 cursor-pointer">
                              {
                                    colaboradores.map((colaborador, index) => (
                                          <div className="w-[300px] h-[200px] p-5 border border-[#ED3A4F]-500 rounded-xl my-5 flex flex-col justify-center items-center shadow-lg 
